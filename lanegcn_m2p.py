...
config["preprocess_train_src"] = os.path.join(
    root_path, "dataset","preprocess", "mia_train_crs_dist6_angle90_small.p"
)
config["preprocess_train_tar"] = os.path.join(
    root_path, "dataset","preprocess", "pit_train_crs_dist6_angle90_small.p"
)
config["preprocess_val_src"] = os.path.join(
    root_path,"dataset", "preprocess", "mia_val_crs_dist6_angle90_small.p"
)

config["preprocess_val_tar"] = os.path.join(
    root_path,"dataset", "preprocess", "pit_val_crs_dist6_angle90_small.p"
)


config['preprocess_test'] = os.path.join(root_path, "dataset",'preprocess', 'pit_test_test_small.p')
